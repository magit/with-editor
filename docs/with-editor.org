...
#+texinfo: @noindent
This manual is for With-Editor version 3.5.3.
...
environment variable in ~shell-mode~, ~eshell-mode~, ~term-mode~, ~vterm-mode~
and ~eat-mode~ buffers.  Use this Emacs command before executing a shell
...
** I am unable to commit with Magit
